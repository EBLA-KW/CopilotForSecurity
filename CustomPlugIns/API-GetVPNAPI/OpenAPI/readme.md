# Copilot for Security Custom Plugin - API - Get VPN API.IO Information
...
1. Obtain the file [API-GetShodanIP.yaml](https://github.com/SCStelz/CopilotForSecurity/blob/main/CustomPlugIns/API-GetVPNAPI/API-GetVPNAPI.yaml) from this directory.
